    ...
    <nav className="fixed top-0 w-full z-50 bg-[#0D1B2A]/90 backdrop-blur border-b border-[#00C2D4]/10">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm text-gray-300">
          ...
          <Link to="/scan" className="hover:text-[#00C2D4] transition-colors">Live Scan</Link>
          <Link to="/dashboard" className="hover:text-[#00C2D4] transition-colors">Dashboard</Link>
        </div>
        <div className="flex items-center gap-3">
          <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">Log in</a>
          <Link to="/connect" className="bg-[#00C2D4] text-[#0D1B2A] font-semibold text-sm px-4 py-2 rounded hover:bg-[#33d4e3] transition-colors">
            Start Free
          </Link>
        </div>
      </div>
